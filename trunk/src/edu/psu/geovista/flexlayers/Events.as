package edu.psu.geovista.flexlayers
{
	...
	public class Events
	{
    	...
    	public function attachToElement(element:Object):void {
    		for (var i = 0; i < Events.BROWSER_EVENTS.length; i++) {
	            var eventType = Events.BROWSER_EVENTS[i];
    	...
    	public function register(type:String, obj:Object, func:Function) {
    	...
    	public var CLASS_NAME:String = "Events";
	}
}