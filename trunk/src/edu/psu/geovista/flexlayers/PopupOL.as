package edu.psu.geovista.flexlayers
{
	...
	public class PopupOL
	{
	    ...
	    public function PopupOL(id:String, lonlat:LonLat, size:Size, contentHTML:String, closeBox:Boolean):void {
	    	if (id == null) {
	            id = Util.createUniqueID(this.CLASS_NAME + "_");
	        }
	        ...
	        var id = this.canvas.id + "_contentDiv";
	        ...
	        if (closeBox == true) {
	            var closeSize = new Size(17,17);
	            var img = Util.getImagesLocation() + "close.gif";
	            ...
	            var closePopup = function(evt:MouseEvent) {
		...
		public var CLASS_NAME:String = "PopupOL";
